var API=function(){var e=function(e,n,a){$.ajax({type:"POST",url:e,data:JSON.stringify(n)||{},contentType:"application/json; charset=UTF-8",dataType:"json",success:function(e){a(null,e)},error:function(e,n,t){a({msg:t})}})},n={createChallenge:"/challenge/create",getChallenge:"/challenge/search",sendMessage:"/sendMessage"};return{consume:function(a,t,c){e(n[a],t,c)}}}();
...
var KeyCode={27:"ESC",32:"space",48:"0",49:"1",50:"2",51:"3",52:"4",53:"5",54:"6",55:"7",56:"8",57:"9",65:"a",66:"b",67:"c",68:"d",69:"e",70:"f",71:"g",72:"h",73:"i",74:"j",75:"k",76:"l",77:"m",78:"n",79:"o",80:"p",81:"q",82:"r",83:"s",84:"t",85:"u",86:"v",87:"w",88:"x",89:"y",90:"z",96:"0",97:"1",98:"2",99:"3",100:"4",101:"5",102:"6",103:"7",104:"8",105:"9"};
var dispatcher=function(){var e={},n={};return window.onkeydown=function(e){var n=e.keyCode?e.keyCode:e.which,i=KeyCode[n],o=$("dialog").css("display");32==n&&"none"==o&&e.preventDefault(),dispatcher.execute("emit",i)},{subscribeKey:function(n,i){e[n]=i},unsubscribeKey:function(n){e[n]=function(){}},unsubscribe:function(e){delete n[e]},subscribe:function(e,i){n[e]=i},execute:function(e,i){return e in n?n[e](i):void 0},show:function(){for(var n in e)console.log(n,e[n])}}}();
var CountDown;CountDown=function(n){var o;n=n||{},this.interval=null,o=function(){},this.onEnd=n.onFinish||o,this.time=1e3*n.time,this.showOnSeconds=n.showOnSeconds||o},CountDown.prototype.start=function(){var n,o;return o=this,n=this.time,this.interval=setInterval(function(){0===n?(console.log("finish"),o.onEnd(),o.stop()):n%1e3===0&&o.showOnSeconds(n/1e3),n-=100},100),this},CountDown.prototype.stop=function(n){return console.log("stop"),clearInterval(this.interval),n?n():void 0},"undefined"!=typeof exports&&(exports.CountDown=CountDown);
var HeroManager;HeroManager=function(){this.heros={}},HeroManager.prototype.invoker=function(){var e,n,c,a,l;return e=[],e.push(new Skill({canBeChallenge:!0,srcImg:"cold_snap",name:"cold snap",clickNeeded:!0,dependencies:"qqq",effect:"stun",key:"y"})),e.push(new Skill({canBeChallenge:!0,srcImg:"sun_strike",name:"sun strike",clickNeeded:!0,secondsCd:2,dependencies:"eee",hitTime:1.7,endDurationDmg:475,key:"t"})),e.push(new Skill({canBeChallenge:!0,name:"ghost walk",srcImg:"ghost_walk",clickNeeded:!1,dependencies:"qqw",key:"v"})),e.push(new Skill({canBeChallenge:!0,name:"ice wall",srcImg:"ice_wall",clickNeeded:!1,dependencies:"qqe",effect:"slow",key:"g"})),e.push(new Skill({canBeChallenge:!0,name:"emp",srcImg:"emp",clickNeeded:!0,dependencies:"www",hitTime:2.9,endDurationDmg:275,key:"c"})),e.push(new Skill({canBeChallenge:!0,name:"tornado",srcImg:"tornado",clickNeeded:!0,dependencies:"wwq",effect:"invulnerable",duration:2.5,endDurationDmg:385,key:"x"})),e.push(new Skill({canBeChallenge:!0,name:"alacrity",srcImg:"alacrity",clickNeeded:!0,dependencies:"wwe",key:"z"})),e.push(new Skill({canBeChallenge:!0,name:"forge spirit",srcImg:"forge_spirit",clickNeeded:!1,dependencies:"eeq",key:"f"})),e.push(new Skill({canBeChallenge:!0,name:"deafening blast",srcImg:"deafening_blast",clickNeeded:!0,dependencies:"qwe",key:"b"})),e.push(new Skill({canBeChallenge:!0,name:"chaos meteor",srcImg:"chaos_meteor",clickNeeded:!0,dependencies:"wee",hitTime:1.3,key:"d"})),n=[],n.push(new Skill({name:"quas",key:"q",secondsCd:0,canBeChallenge:!1,srcImg:"quas",clickNeeded:!1,customFun:function(){var e;e={key:"q",srcImg:"quas"},dispatcher.execute("addInvokerState",e)}})),n.push(new Skill({name:"wex",key:"w",secondsCd:0,canBeChallenge:!1,srcImg:"wex",clickNeeded:!1,customFun:function(){var e;e={key:"w",srcImg:"wex"},dispatcher.execute("addInvokerState",e)}})),n.push(new Skill({name:"exort",key:"e",secondsCd:0,canBeChallenge:!1,srcImg:"exort",clickNeeded:!1,customFun:function(){var e;e={key:"e",srcImg:"exort"},dispatcher.execute("addInvokerState",e)}})),l=function(e){return function(){dispatcher.execute("useExtraSkill",e)}},n.push(new Skill({customFun:l(3),key:"d"})),n.push(new Skill({customFun:l(4),key:"f"})),a=function(e){return function(){var n,c,a,l;for(a=dispatcher.execute("getLastSkill"),c=0;c<e.length;){if(n=e[c].dependencies,l=e[c].name,a!==l&&dispatcher.execute("isSameInvokerState",n)){dispatcher.execute("changeSkill",c);break}c++}}},n.push(new Skill({name:"invoke",key:"r",secondsCd:0,canBeChallenge:!1,srcImg:"invoke",clickNeeded:!1,customFun:a(e)})),c=new Hero({name:"invoker",skills:n,extraSkills:e,srcImg:"invoker"})},HeroManager.prototype.create=function(){return this.heros.invoker=this.invoker(),this};
var Challenge;Challenge=function(){this.wishSteps=[],this.wishLength=0,this.steps=[],this.currentStep=0,this.active=!1,this.isOver=!1,this.challengeLog=new ChallengeLog},Challenge.prototype.set=function(t){var e,s;for(this.challengeLog.finish,s=0,this.wishSteps=[];s<t.length;)e=t[s],this.wishSteps.push({name:e.name,srcImg:e.srcImg,done:!1}),s++;return this.wishLength=t.length,this.currentStep=0,this.steps=[],this.active=!1,this},Challenge.prototype.start=function(){return this.clean(),this.challengeLog.start(),this.active=!0,this.isOver=!1,this},Challenge.prototype.clean=function(){var t;for(this.currentStep=0,this.challengeLog.clean(),t=0;t<this.wishSteps.length;)this.wishSteps[t].done=!1,t++;return this},Challenge.prototype.stop=function(){return this.active?this.finish():this.isOver=!1,this},Challenge.prototype.finish=function(){return this.challengeLog.finish(),this.isOver=!0,console.log("tiempo fue de",this.challengeLog.time," s"),this.active=!1,this},Challenge.prototype.getSummary=function(){return this.challengeLog.getSummary(),this},Challenge.prototype.step=function(t){var e;return e=t.name,this.active?(this.wishSteps.length>this.currentStep&&this.wishSteps[this.currentStep].name===e&&(this.wishSteps[this.currentStep].done=!0,this.challengeLog.add(t),this.currentStep++),this.wishSteps.length===this.currentStep&&this.finish(),this):this},"undefined"!=typeof exports&&(exports.Challenge=Challenge);
var ChallengeLog;ChallengeLog=function(){this.queue={},this.tryhard=[],this.startTime=0,this.finishTime=0,this.time=0,this.listSkills=[],this.summary=new Summary({challengeLog:this})},ChallengeLog.prototype.clean=function(){return this.queue={},this.tryhard=[],this.startTime=-2,this.finishTime=0,this.time=0,this.listSkills=[],this.summary.clean,this},ChallengeLog.prototype.start=function(){return this.clean(),this.startTime=(new Date).getTime(),this},ChallengeLog.prototype.add=function(t){return this.tryhard.push({obj:t,time:(new Date).getTime()}),this},ChallengeLog.prototype.setStatus=function(t,e){return this.listSkills[t].status=e,this},ChallengeLog.prototype.finish=function(){return this.finishTime=(new Date).getTime(),this.time=(this.finishTime-this.startTime)/1e3,this.getSummary(),this},ChallengeLog.prototype.getSummary=function(){var t,e,i,s,h;for(e=0,i=this.tryhard.length;i>e;){switch(t=this.tryhard[e].obj,h=this.tryhard[e].time-this.startTime,s={},s.srcImg=t.srcImg,s.castTime=h,s.hitTime=h+1e3*t.hitTime,s.duration=1e3*t.duration+s.hitTime,s.status=!1,this.listSkills.push(s),t.effect){case"invulnerable":this.summary.add({name:t.name,effect:t.effect,toggle:1,time:s.hitTime,index:e}),this.summary.add({name:t.name,effect:t.effect,toggle:-1,time:s.duration,index:e});break;default:this.summary.add({name:t.name,effect:t.effect,time:s.duration,damage:t.endDurationDmg,index:e})}e++}return this.summary.generate(),console.log("listSkills",this.listSkills),this},"undefined"!=typeof exports&&(exports.ChallengeLog=ChallengeLog);
var Hero,Skill;Skill=function(i){var e;i=i||{},this.name=i.name||"",this.srcImg=i.srcImg||"no-skill",this.canBeChallenge=i.canBeChallenge,this.key=i.key||"",this.dependencies=i.dependencies||"",this.secondsCd=i.secondsCd||0,this.onCooldown=!1,this.countdown=null,this.hitTime=i.hitTime||0,this.duration=i.duration||0,this.hitDmg=i.hitDamage||0,this.dmgPerSecond=i.damagePerSecond||0,this.endDurationDmg=i.endDurationDmg||0,this.effect=i.effect||"",this.clickNeeded=i.clickNeeded,e=function(){dispatcher.execute("useSkill",this)},this.customFun=i.customFun||e},Skill.prototype.finishCd=function(){this.onCooldown=!1},Skill.prototype.stop=function(){this.countdown&&(this.countdown.stop(),this.onCooldown=!1)},Skill.prototype.fun=function(i){var e,t;!this.clickNeeded||this.clickNeeded&&i?(dispatcher.unsubscribe("clickTarget",e),this.customFun()):(t=this,e=function(){t.fun.bind(t)(!0)},dispatcher.subscribe("clickTarget",e))},Skill.prototype.clean=function(){console.log("skill clean"),this.name="",this.srcImg="no-skill",this.canBeChallenge=!1,this.dependencies=""},Hero=function(i){i=i||{},this.name=i.name||"",this.srcImg=i.srcImg||"",this.skills=i.skills||[],this.extraSkills=i.extraSkills||[]},Hero.prototype.exe=function(i){this.skills[i].fun()};
var ItemManager;ItemManager=function(){this.items={}},ItemManager.prototype.create=function(){return this.items.dagon=new Item({name:"dagon",clickNeeded:!0,secondsCd:2,srcImg:"dagon",endDurationDmg:800}),this.items.ethereal=new Item({name:"ethereal",clickNeeded:!0,secondsCd:2,srcImg:"ethereal",endDurationDmg:75}),this.items.eul=new Item({name:"eul",clickNeeded:!0,secondsCd:2,srcImg:"eul",duration:2.5,endDurationDmg:50,effect:"invulnerable"}),this.items.scythe=new Item({name:"scythe",clickNeeded:!0,secondsCd:2,srcImg:"scythe",duration:3.5,effect:"hex"}),this.items.shiva=new Item({name:"shiva",clickNeeded:!1,secondsCd:2,srcImg:"shivas",endDurationDmg:200,effect:"slow"}),this.items["no-item"]=new Item({name:"",clickNeeded:!1,srcImg:"no-item"}),this};
var Item,ItemsSlots;Item=function(t){t=t||{},this.name=t.name||"",this.srcImg=t.srcImg||"",this.clickNeeded=t.clickNeeded||!1,this.secondsCd=t.secondsCd||0,this.onCooldown=!1,this.countdown=null,this.hitTime=t.hitTime||0,this.duration=t.duration||0,this.hitDmg=t.hitDamage||0,this.dmgPerSecond=t.damagePerSecond||0,this.endDurationDmg=t.endDurationDmg||0,this.effect=t.effect||""},Item.prototype.finishCd=function(){this.onCooldown=!1},Item.prototype.stop=function(){this.countdown&&(this.countdown.stop(),this.onCooldown=!1)},Item.prototype.fun=function(t){var e,s;!this.clickNeeded||this.clickNeeded&&t?(dispatcher.unsubscribe("clickTarget",e),dispatcher.execute("useSkill",this)):(s=this,e=function(){s.fun.bind(s)(!0)},dispatcher.subscribe("clickTarget",e))},ItemsSlots=function(){var t,e,s,i,o;for(this.slots=[],e=["z","x","c","v","b","n"],s=["dagon","ethereal","eul","scythe","shiva","no-item"],t=o=0;5>=o;t=++o)i={key:e[t],item:itemMng.items[s[t]]},this.slots.push(i)},ItemsSlots.prototype.launch=function(t){this.slots[t].item.fun()},ItemsSlots.prototype.clean=function(){this.slots=[]},"undefined"!=typeof exports&&(exports.ItemsSlots=ItemsSlots,exports.Item=Item);
var SkillSlot=React.createClass({displayName:"SkillSlot",render:function(){var e="same-line skill "+this.props.item.obj.srcImg;return React.DOM.li({className:e,key:this.props.key},React.DOM.div({className:"key-bind"},this.props.item.key))}}),SkillList=React.createClass({displayName:"SkillList",getInitialState:function(){return dispatcher.subscribe("changeSkill",this.changeSkill),dispatcher.subscribe("getLastSkill",this.getLastSkill),dispatcher.subscribe("useExtraSkill",this.useExtraSkill),{skills:this.props.list,lastSkill:""}},clearLastSkill:function(){this.setState({lastSkill:""})},createFun:function(e){return function(t){e.fun(t)}},useExtraSkill:function(e){this.state.skills[e].obj.fun()},getLastSkill:function(){return this.state.lastSkill},changeSkill:function(e){var t=this.props.extraSkills,a=this.state.skills,s=a[4].key;a[4].obj=a[3].obj,a[3].obj=t[e],this.props.legacyMode&&(a[4].key=a[4].obj.key,a[3].key=a[3].obj.key,dispatcher.execute("unregisterEvent",{name:"goGame",key:s}),dispatcher.execute("registerEvent",{name:"goGame",key:a[4].key,action:function(){dispatcher.execute("useExtraSkill",4)}}),dispatcher.execute("registerEvent",{name:"goGame",key:a[3].key,action:function(){dispatcher.execute("useExtraSkill",3)}})),this.setState({skills:a,lastSkill:t[e].name})},render:function(){return React.DOM.div({className:"hero-skill-slots"},React.DOM.ul({className:"clear-list"},this.state.skills.map(function(e,t){return SkillSlot({key:t,item:e})},this)))}}),ItemSlot=React.createClass({displayName:"ItemSlot",render:function(){var e="item same-line "+this.props.slot.item.srcImg;return React.DOM.li({className:e,key:this.props.key},React.DOM.div({className:"key-bind"},this.props.slot.key))}}),ItemList=React.createClass({displayName:"ItemList",getInitialState:function(){return{itemsSlots:this.props.itemsSlots}},createLaunch:function(e,t){return function(){e.launch(t)}},render:function(){return React.DOM.div({className:"hero-item-slots same-line vert-bot"},React.DOM.ul({className:"clear-list"},this.state.itemsSlots.slots.map(function(e,t){return ItemSlot({key:t,slot:e})},this)))}}),InvokerStatus=React.createClass({displayName:"InvokerStatus",getInitialState:function(){return dispatcher.subscribe("addInvokerState",this.addState),dispatcher.subscribe("clearInvokerState",this.clear),dispatcher.subscribe("isSameInvokerState",this.isSameState),{status:[{},{},{}]}},clear:function(){this.setState({status:[{},{},{}]})},addState:function(e){for(var t=this.state.status,a=0;a<t.length-1;a++)t[a]=t[a+1];t[2]=e,this.setState({status:t})},isSameState:function(e){var t=[e.charAt(0),e.charAt(1),e.charAt(2)];t.sort();for(var a=[],s=0;s<this.state.status.length;s++)a[s]=this.state.status[s].key;var i=a.slice(0);i.sort();for(var s=0;s<i.length;s++)if(i[s]!=t[s])return!1;return!0},render:function(){return React.DOM.ul({className:"clear-list"},this.state.status.map(function(e,t){var a="zoom-status same-line "+e.srcImg;return React.DOM.li({key:t,className:a}," ",e.key)},this))}}),HeroTemplate=React.createClass({displayName:"HeroTemplate",render:function(){var e="hero-img "+this.props.heroData.srcImg;return React.DOM.div({className:"hero-block same-line-top"},React.DOM.div({className:"hero-details same-line-top"},React.DOM.div({className:"hero-name"},this.props.heroData.name),React.DOM.div({className:e})),React.DOM.div({className:"same-line vert-bot"},InvokerStatus(null),SkillList({list:this.props.heroData.skills,extraSkills:this.props.heroData.extraSkills,legacyMode:this.props.legacyMode})))}}),ChallengeStep=React.createClass({displayName:"ChallengeStep",render:function(){var e="";this.props.item.done||(e=" no-used");var t="same-line zoom-challenge "+this.props.item.srcImg+e;return React.DOM.li({className:t,key:this.props.key})}}),StepToChooseFrom=React.createClass({displayName:"StepToChooseFrom",render:function(){var e="same-line zoom-challenge "+this.props.item.srcImg;return React.DOM.li({className:e,key:this.props.key,onClick:this.props.addStep.bind(null,this.props.item)})}}),SelectChallenge=React.createClass({displayName:"SelectChallenge",getInitialState:function(){return{steps:[],listChallenge:listChallenge}},addStep:function(e){var t=this.state.steps;t.push(e),this.setState({steps:t})},selectListChallenge:function(e){for(var t,a,s=this.state.listChallenge[e],i=[],l="",n=0;n<s.length;n++)if(l=s[n].name,"skills"==s[n].src){t=this.props.heroSelected.skills;for(var c=0;c<t.length;c++)if(l==t[c].obj.name){i.push(t[c].obj);break}}else if("extraSkills"==s[n].src){t=this.props.heroSelected.extraSkills;for(var c=0;c<t.length;c++)if(l==t[c].name){i.push(t[c]);break}}else if("items"==s[n].src){a=this.props.itemsSelected.slots;for(var c=0;c<a.length;c++)if(l==a[c].item.name){i.push(a[c].item);break}}this.setState({steps:i})},setChallenge:function(){dispatcher.execute("setChallenge",this.state.steps)},clearChallenge:function(){this.setState({steps:[]})},render:function(){var e,t,a=[],s=[],i=[],l="clear-list ";e=this.props.heroSelected.skills;for(var n=0;n<e.length;n++)e[n].obj.canBeChallenge&&a.push(e[n].obj);e=this.props.heroSelected.extraSkills;for(var n=0;n<e.length;n++)e[n].canBeChallenge&&s.push(e[n]);for(var t=this.props.itemsSelected.slots,n=0;n<t.length;n++)t[n].item.name.length&&i.push(t[n].item);return this.state.steps.length&&(l+="hide"),React.DOM.div({id:"tab-set-challenge",className:"select-challenge same-line-top tab-content"},React.DOM.h2({className:"tab-title text-center"},"Create your own challenge or use defaults"),React.DOM.section({className:"center-block"},React.DOM.label(null,"Custom skills to add to challenge"),React.DOM.ul({className:"custom-step clear-list"},a.map(function(e,t){return StepToChooseFrom({key:t,item:e,addStep:this.addStep})},this),s.map(function(e,t){return StepToChooseFrom({key:t,item:e,addStep:this.addStep})},this),i.map(function(e,t){return StepToChooseFrom({key:t,item:e,addStep:this.addStep})},this)),React.DOM.div({className:"top-10"},React.DOM.label(null,"Default challenges"),React.DOM.ul({className:"challenge-list"},this.state.listChallenge.map(function(e,t){return React.DOM.li({onClick:this.selectListChallenge.bind(null,t)},e.map(function(e,t){var a="same-line zoom-challenge "+e.srcImg;return React.DOM.span({className:a,key:t})},this))},this))),React.DOM.div({className:"preview-challenge"},React.DOM.h4(null,"Preview challenge"),React.DOM.ul({className:l},React.DOM.li({className:"same-line zoom-challenge no-item-challenge"}),React.DOM.li({className:"same-line zoom-challenge no-item-challenge"}),React.DOM.li({className:"same-line zoom-challenge no-item-challenge"}),React.DOM.li({className:"same-line zoom-challenge no-item-challenge"}),React.DOM.li({className:"same-line zoom-challenge no-item-challenge"})),React.DOM.ul({className:"clear-list"},this.state.steps.map(function(e,t){var a="same-line zoom-challenge "+e.srcImg;return React.DOM.li({className:a,key:t})},this)),React.DOM.button({onClick:this.clearChallenge,className:"button btn-default"},"Clear"),React.DOM.button({onClick:this.setChallenge,className:"button btn-default"},"Set challenge"))))}}),ChallengeTemplate=React.createClass({displayName:"ChallengeTemplate",getInitialState:function(){dispatcher.subscribe("useSkill",this.action),dispatcher.subscribe("setChallenge",this.setChallenge),dispatcher.subscribe("stopChallenge",this.stop);var e=new Challenge;return e.set([]),{challenge:e,message:"Choose challenge",startButton:"Start",countDown:null,urlChallenge:"<- Challenge your friend",wasChallenge:!1,friendData:{msg:"",time:""}}},componentDidMount:function(){var e=$("#challenge").text()||"";e.length&&API.consume("getChallenge",{id:e},this.searchChallenge)},searchChallenge:function(e,t){if(e)return void console.log(e);if("OK"!=t.msg)return void console.log(t.msg);var a=t.data,s=a.list,i=this.state.friendData;i.time=a.time,this.setState({friendData:i}),this.setChallenge(s,!0)},setChallenge:function(e,t){this.props.changeTabGame(),t=t||!1,this.stop(),this.setState({challenge:this.state.challenge.set(e),startButton:"Start",wasChallenge:t})},action:function(e){this.setState({challenge:this.state.challenge.step(e)}),this.state.challenge.active||dispatcher.execute("switchStatus",{name:"goGame",status:!1})},generateUrl:function(){var e={};e.time=this.state.challenge.challengeLog.time,e.list=this.state.challenge.wishSteps,API.consume("createChallenge",{data:e},this.setUrlChallenge)},setMessage:function(e){this.setState({message:e})},clearChallenge:function(){dispatcher.execute("clearInvokerState"),dispatcher.unsubscribe("clickTarget")},startChallenge:function(){this.clearChallenge(),dispatcher.execute("switchStatus",{name:"goGame",status:!0}),this.setState({challenge:this.state.challenge.start(),message:"",startButton:"Restart"})},onStart:function(){dispatcher.execute("clearHero");var e=this.state.countDown,t=this,a=function(){var e=new CountDown({onFinish:t.startChallenge,time:3,showOnSeconds:t.setMessage});e.start(),t.setState({countDown:e})};e?e.stop(a):a()},start:function(){var e=this.state.challenge;e.wishSteps.length?(this.setState({message:"Game starts in ..."}),this.stop(),setTimeout(this.onStart,500)):this.setState({message:"Choose challenge"})},stop:function(){dispatcher.execute("clearHero"),this.clearChallenge(),dispatcher.execute("switchStatus",{name:"goGame",status:!1});var e=this.state.challenge.stop();this.setState({challenge:e})},setUrlChallenge:function(e,t){if(e)return void console.log(e);if("OK"!=t.msg)return void console.log(t.msg);console.log(t);var a=window.location.host+"/"+t.url;this.setState({urlChallenge:a})},clickTarget:function(){dispatcher.execute("clickTarget")},render:function(){var e=this.state.challenge.isOver?"":"hide",t="message-block ";0==this.state.message.length&&(t=" hide");var a=this.state.wasChallenge?"":"hide";return React.DOM.div({className:"challenge-block"},React.DOM.h2({className:"tab-title text-center"},"Start your challenge"),React.DOM.button({className:"button btn-default",onClick:this.start},this.state.startButton),React.DOM.ul({className:"clear-list"},this.state.challenge.wishSteps.map(function(e,t){return ChallengeStep({key:t,item:e})},this)),React.DOM.div({className:e},React.DOM.div(null,"Time ",this.state.challenge.challengeLog.time," seconds"),React.DOM.div({className:a},"Your friend finished this",React.DOM.span({className:"cross-out"}," stupid "),"challenge in ",this.state.friendData.time," seconds"),React.DOM.button({className:"button btn-default",onClick:this.generateUrl},"Generate Url"),React.DOM.span(null,React.DOM.b(null," ",this.state.urlChallenge)),SummaryView({summary:this.state.challenge.challengeLog})),React.DOM.div({className:"field"},React.DOM.div({className:"message-block"},React.DOM.div({className:"message"},this.state.message)),React.DOM.div({className:"target",onClick:this.clickTarget})))}});SummaryView=React.createClass({displayName:"SummaryView",format3Decimals:function(e){return e/1e3},render:function(){var e=this,t=this.props.summary.listSkills.map(function(t){var a="same-line zoom-challenge "+t.srcImg,s=e.format3Decimals(t.castTime),i=e.format3Decimals(t.hitTime),l=e.format3Decimals(t.duration),n="fa fa-"+(t.status?"check":"close");return React.DOM.tr(null,React.DOM.td(null,React.DOM.div({className:a})),React.DOM.td(null,s),React.DOM.td(null,i),React.DOM.td(null,l),React.DOM.td(null,React.DOM.i({className:n})))});return React.DOM.div({className:"summary"},React.DOM.h3(null,"Summary"),React.DOM.table({className:"summary-table"},React.DOM.thead(null,React.DOM.tr(null,React.DOM.th(null,"Action"),React.DOM.th(null,"cast time"),React.DOM.th(null,"hit time"),React.DOM.th(null,"duration time"),React.DOM.th(null,"status"))),React.DOM.tbody(null,t)))}});var PickHeroView=React.createClass({displayName:"PickHeroView",render:function(){return React.DOM.section({id:"tab-pick-hero",className:"tab-content"},React.DOM.h2({className:"tab-title text-center"},"Choose a hero"),React.DOM.div({className:"soon text-center"},"Coming soon"))}}),PickItemView=React.createClass({displayName:"PickItemView",render:function(){return React.DOM.section({id:"tab-pick-item",className:"tab-content"},React.DOM.h2({className:"tab-title text-center"},"Choose your items"),React.DOM.div({className:"soon text-center"},"Coming soon"))}}),SettingsView=React.createClass({displayName:"SettingsView",getInitialState:function(){return{type:"",index:-1,skillKeys:["q","w","e","d","f","r"],activeSkills:[!1,!1,!1,!1,!1,!1],activeItems:[!1,!1,!1,!1,!1,!1]}},checkIfUsed:function(e){for(var t=this.state.skillKeys,a=0;a<t.length;a++)t[a]==e&&(this.props.updateKeySkill(a," "),t[a]=" ",this.setState({skillKeys:t}))},listenKey:function(e){if(this.switchStatus(!1),this.checkIfUsed(e),"item"==this.state.type&&this.props.updateKeyItem(this.state.index,e),"skill"==this.state.type){this.props.updateKeySkill(this.state.index,e);var t=this.state.skillKeys;t[this.state.index]=e,this.setState({skillKeys:t})}},componentDidMount:function(){var e=this,t={name:"settings",key:"",action:function(t){e.listenKey(t)}};dispatcher.execute("registerEvent",t)},switchStatus:function(e){dispatcher.execute("switchStatus",{name:"settings",status:e})},updateActive:function(e,t,a){if(-1!=e)if("skill"==t){var s=this.state.activeSkills;s[e]=a,this.setState({activeSkills:s})}else{var i=this.state.activeItems;i[e]=a,this.setState({activeItems:i})}},newActive:function(e,t){this.updateActive(this.state.index,this.state.type,!1),this.updateActive(e,t,!0)},updateKey:function(e,t){"skill"==t&&this.props.legacyMode||(this.switchStatus(!0),this.newActive(e,t),$("body").off("click"),$("body").on("click",function(){this.switchStatus(!1),$("body").off("click"),this.updateActive(this.state.index,this.state.type,!1)}.bind(this)),this.setState({type:t,index:e}))},toggleLegacy:function(){var e=!this.state.legacyMode;this.props.toggleLegacy(e),this.setState({legacyMode:e})},render:function(){var e=[1,2,3,4,5,"U"],t=this.state.skillKeys.map(function(t,a){var s="same-line-top slot "+(this.state.activeSkills[a]?"selected":"");return React.DOM.li({className:s,onClick:this.updateKey.bind(null,a,"skill")},React.DOM.span({className:"key"},t),React.DOM.span({className:"text"},e[a]))}.bind(this)),a=this.props.itemsSlots.map(function(e,t){var a="same-line-top slot "+(this.state.activeItems[t]?"selected":"");return React.DOM.li({className:a,onClick:this.updateKey.bind(null,t,"item")},React.DOM.span({className:"key"},e.key))}.bind(this));return React.DOM.section({id:"tab-settings",className:"tab-content settings"},React.DOM.h2({className:"tab-title text-center"},"Set your custom keys and more"),React.DOM.div({className:"row"},React.DOM.label({className:"label alert"},"Click slot and press key. Allowed keys 'a' to 'z' , '0' to '9' and space bar.")),React.DOM.div({className:"row"},React.DOM.div({className:"legacy-label"},"Legacy Mode"),React.DOM.div({className:"legacy-switch"},React.DOM.input({type:"checkbox",id:"legacyModeSwitch",checked:this.props.legacyMode,className:"cmn-toggle cmn-toggle-round-flat"}),React.DOM.label({"for":"legacyModeSwitch",onClick:this.props.toggleLegacy}))),React.DOM.div({className:"row"},React.DOM.label({className:"label"},"Skills"),React.DOM.ul({className:"clear-list"},t)),React.DOM.div({className:"row"},React.DOM.label({className:"label"},"Items"),React.DOM.ul({className:"clear-list items-slots"},a)))}}),DialogView=React.createClass({displayName:"DialogView",getInitialState:function(){return{dialog:null,content:"",error:[!1,!1,!1]}},mixins:[React.addons.LinkedStateMixin],componentDidMount:function(){var e=document.querySelector("dialog");dialogPolyfill.registerDialog(e),this.setState({dialog:e})},closeDialog:function(){this.state.dialog.close()},send:function(){var e=this.state.error,t=!1,a=this.refs.selectSup.getDOMNode().value,s=this.refs.selectFeel.getDOMNode().value,i={sup:a,feel:s,content:this.state.content};if("Pick one"==i.sup&&(e[0]=!0,t=!0),"Pick one"==i.feel&&(e[1]=!0,t=!0),i.content.length||(e[2]=!0,t=!0),!t){API.consume("sendMessage",i,function(e,t){console.log("form",e,t)});var l=this;setTimeout(function(){l.state.dialog.close()},500)}this.setState({error:e})},openDialog:function(){dispatcher.execute("stopChallenge"),this.setState({content:"",chooseFeel:"Pick one",supSelected:"Pick one",error:[!1,!1,!1]}),this.state.dialog.showModal()},updateField:function(e){var t=this.state.error;t[e]=!1,this.setState({error:t})},updateContent:function(e){this.setState({content:e.target.value}),this.updateField(2)},render:function(){var e=["Pick one","HAPPY","LOL","OMG","WTF","MEH","F*CK","STFU"],t=e.map(function(e){return React.DOM.option({value:e},e)}),a=["Pick one","Bug","New feature","Commend","Something else"],s=a.map(function(e){return React.DOM.option({value:e},e)}),i="error "+(this.state.error[0]?"show":"hide"),l="error "+(this.state.error[1]?"show":"hide"),n="error "+(this.state.error[2]?"show":"hide");return React.DOM.div({className:"dialog-report"},React.DOM.button({className:"open-dialog",onClick:this.openDialog},"Report or commend"),React.DOM.dialog(null,React.DOM.h2(null,"Report or Commend"),React.DOM.div({className:"row"},React.DOM.div({className:i},"Yo, pick an option"),React.DOM.label(null,"Sup?"),React.DOM.select({ref:"selectSup",defaultValue:"Pick one",onChange:this.updateField.bind(null,0)},s)),React.DOM.div({className:"row"},React.DOM.div({className:l},"Choose wisely, take your time"),React.DOM.label(null,"How does it make you feel?"),React.DOM.select({ref:"selectFeel",defaultValue:"Pick one",onChange:this.updateField.bind(null,1)},t)),React.DOM.div({className:n},"Game is hard. I know you can fill it. I’ll wait."),React.DOM.label({"for":""},"What’s going on?"),React.DOM.div({className:"row"},React.DOM.textarea({value:this.state.content,onChange:this.updateContent})),React.DOM.div({className:"row"},React.DOM.button({className:"button btn-normal",onClick:this.closeDialog},"Close"),React.DOM.button({className:"button btn-default",onClick:this.send},"Send"))))}}),BaseTemplate=React.createClass({displayName:"BaseTemplate",getInitialState:function(){dispatcher.subscribe("clearHero",this.clearHero);var e=new TabsManager([new Tab({name:"pickHero",text:"1) Pick hero",target:"#tab-pick-hero"}),new Tab({name:"pickItem",text:"2) Pick items",target:"#tab-pick-item"}),new Tab({name:"settings",text:"3) Settings",target:"#tab-settings"}),new Tab({name:"setChallenge",text:"4) Set Challenge",target:"#tab-set-challenge"}),new Tab({name:"goGame",text:"5) Go game",target:"#tab-game",noFocus:function(){dispatcher.execute("stopChallenge")}}),new Tab({name:"nextFeature",text:"Choose next features",target:"#next-feature"})]);return dispatcher.subscribe("emit",function(t){e.emit(t)}),dispatcher.subscribe("registerEvent",function(t){e.registerEvent(t.name,t.key,t.action)}),dispatcher.subscribe("switchStatus",function(t){e.switchStatus(t.name,t.status)}),dispatcher.subscribe("getActiveTab",e.getActive),{tabsMng:e,data:this.props.data,itemsSlots:new ItemsSlots,legacyMode:!1}},componentDidMount:function(){var e,t;e=heroMng.heros.invoker,this.updateHero(e),this.changeTab(2);for(var a=0;a<this.state.itemsSlots.slots.length;a++){t=this.state.itemsSlots.slots[a];var s={name:"goGame",key:t.key,action:this.createLaunch(this.state.itemsSlots,a)};dispatcher.execute("registerEvent",s)}},createLaunch:function(e,t){return function(){e.launch(t)}},createFun:function(e){return function(t){e.fun(t)}},updateHero:function(e){var t,a,s,i;i=this.state.data,t=e.skills;for(var l=0;l<t.length;l++){a=t[l],i.skills[l].obj=a,s=a.key;var n={name:"goGame",key:s,action:this.createFun(a)};dispatcher.execute("registerEvent",n)}i.name=e.name,i.srcImg=e.srcImg,i.extraSkills=e.extraSkills;this.setState({data:i})},clearHero:function(){if("invoker"==this.state.data.name){{this.state.tabsMng}dispatcher.execute("registerEvent",{name:"goGame",key:"",action:function(){dispatcher.execute("useExtraSkill",3)}}),dispatcher.execute("registerEvent",{name:"goGame",key:"",action:function(){dispatcher.execute("useExtraSkill",4)}});var e=this.state.data;e.skills[3].obj=new Skill({key:e.skills[3].key,customFun:function(){}}),e.skills[4].obj=new Skill({key:e.skills[4].key,customFun:function(){}}),this.setState({data:e})}},changeTabGame:function(){this.changeTab(4)},changeTab:function(e){var t,a=this.state.tabsMng.activeTab,s=this.state.tabsMng.tabs;a>-1&&(t=s[a].target,$(t).removeClass("tab-show")),t=s[e].target,$(t).addClass("tab-show"),this.setState({tabsMng:this.state.tabsMng.changeTab(e)})},updateKeySkill:function(e,t){this.clearKeyIfItemUse(t);var a=this.state.data,s=a.skills[e],i=s.key,l=this.state.tabsMng;l.unregisterEvent("goGame",i),a.skills[e].key=t;var n={name:"goGame",key:t,action:this.createFun(s.obj)};dispatcher.execute("registerEvent",n),this.setState({data:a})},clearKeyIfItemUse:function(e){for(var t=this.state.itemsSlots,a=0;a<t.slots.length;a++)t.slots[a].key==e&&(t.slots[a].key="");this.setState({itemsSlots:t})},updateKeyItem:function(e,t){var a=this.state.itemsSlots,s=a.slots[e],i=this.state.tabsMng;i.unregisterEvent("goGame",s.key),s.key=t;var l={name:"goGame",key:t,action:this.createLaunch(this.state.itemsSlots,e)};dispatcher.execute("registerEvent",l),this.setState({tabsMng:i,itemsSlots:a})},toggleLegacy:function(){var e=!this.state.legacyMode;if(e)for(var t,a=this.state.data.skills,s=0;s<a.length;s++)t=a[s].obj.key||"",this.updateKeySkill(s,t);this.setState({legacyMode:e})},render:function(){var e=this,t=this.state.tabsMng.activeTab,a=this.state.tabsMng.tabs.map(function(a,s){var i="tab-item button ";return s==t&&(i+="selected"),React.DOM.li({className:"same-line-top"},React.DOM.span({className:i,onClick:e.changeTab.bind(null,s)},a.text))});return React.DOM.div(null,React.DOM.h1({className:"game-title text-center"},"DOTA PRACTICE"),React.DOM.section(null,React.DOM.ul({className:"clear-list text-center"},a)),PickHeroView(null),PickItemView(null),SettingsView({itemsSlots:this.state.itemsSlots.slots,skillSlots:this.state.data.skills,updateKeyItem:this.updateKeyItem,updateKeySkill:this.updateKeySkill,toggleLegacy:this.toggleLegacy,legacyMode:this.state.legacyMode}),SelectChallenge({heroSelected:this.state.data,itemsSelected:this.state.itemsSlots}),React.DOM.section({id:"next-feature",className:"tab-content"},React.DOM.iframe({src:"http://strawpoll.me/embed_1/3192297",className:"poll"},"Loading poll...")),React.DOM.div({id:"tab-game",className:"main-block same-line tab-content"},ChallengeTemplate({changeTabGame:this.changeTabGame,updateHero:this.updateHero,heroSelected:this.state.data,itemsSelected:this.state.itemsSlots}),React.DOM.div({className:"hero-data"},HeroTemplate({heroData:this.state.data,legacyMode:this.state.legacyMode}),ItemList({itemsSlots:this.state.itemsSlots})),React.DOM.div({className:"topics"},"Some skills require a click on an enemy(red circle) to be use.")),DialogView(null))}});
var Summary;Summary=function(e){e=e||{},this.totalDmg=0,this.time=0,this.events=[],this.invulnerable={value:0,index:null},this.result=[],this.challengeLog=e.challengeLog||void 0},Summary.prototype.clean=function(){return this.totalDmg=0,this.time=0,this.events=[],this.invulnerable={value:0,index:null},this.result=[],this},Summary.prototype.add=function(e){return this.events.push(e),this},Summary.prototype.generate=function(){var e,t,i,n,s,l,u;for(t=function(e,t){return e.time-t.time},this.result=this.events.sort(t),i=0,l=this.result.length;l>i;)s=this.result[i],"invulnerable"===s.effect?(e=!1,n=s.index===this.invulnerable.index,u=this.invulnerable.value,(0===u||u>0&&n)&&(e=!0,this.invulnerable.value+=s.toggle,this.invulnerable.index=s.index),this.challengeLog.setStatus(s.index,e)):this.invulnerable.value>0?this.challengeLog.setStatus(s.index,!1):(this.totalDmg+=this.damage,this.challengeLog.setStatus(s.index,!0)),i++;return this},"undefined"!=typeof exports&&(exports.Summary=Summary);
var Tab,TabsManager;Tab=function(t){var e;t=t||{},this.name=t.name||"",this.text=t.text||"",this.target=t.target||"",this.active=!1,this.queueFun={},this.acceptKey=!1,e=function(){},this.noFocus=t.noFocus||e},Tab.prototype.switchStatus=function(t){return this.acceptKey=t,this},Tab.prototype.register=function(t,e){return this.queueFun[t]=e,this},Tab.prototype.unregister=function(t){return t in this.queueFun&&delete this.queueFun[t],this},Tab.prototype.emit=function(t){var e,i;if(this.acceptKey){if(1===Object.keys(this.queueFun).length){e={};for(i in this.queueFun)e=this.queueFun[i];e(t)}else t in this.queueFun&&this.queueFun[t]();return this}},TabsManager=function(t){this.tabs=t,this.activeTab=-1,this.active=!0},TabsManager.prototype.findByName=function(t){var e;for(e=0;e<this.tabs.length&&this.tabs[e].name!==t;)e++;return e},TabsManager.prototype.changeTab=function(t){return this.activeTab>=0&&this.tabs[this.activeTab].noFocus(),this.activeTab=t,this},TabsManager.prototype.unregisterEvent=function(t,e){var i;return i=this.findByName(t),0>i?this:(this.tabs[i].unregister(e),this)},TabsManager.prototype.registerEvent=function(t,e,i){var a;return a=this.findByName(t),0>a?this:(this.tabs[a].register(e,i),this)},TabsManager.prototype.emit=function(t){return this.active&&t?(this.tabs[this.activeTab].emit(t),this):this},TabsManager.prototype.switchStatus=function(t,e){var i;return i=this.findByName(t),0>i?this:(this.tabs[i].switchStatus(e),this)},TabsManager.prototype.getActive=function(){return this.activeTab},"undefined"!=typeof exports&&(exports.TabsManager=TabsManager,exports.Tab=Tab);
var Timer;Timer=function(){return this.time=0,this.timeStart=0},Timer.prototype.start=function(){this.timeStart=(new Date).getTime()},Timer.prototype.stop=function(){var t;t=(new Date).getTime(),this.time=(t-this.timeStart)/1e3};
wtfMode=!0,legacyMode=!1,heroMng=new HeroManager,itemMng=new ItemManager,listChallenge=[[{name:"eul",srcImg:"eul",src:"items"},{name:"sun strike",srcImg:"sun_strike",src:"extraSkills"},{name:"chaos meteor",srcImg:"chaos_meteor",src:"extraSkills"},{name:"deafening blast",srcImg:"deafening_blast",src:"extraSkills"}],[{name:"forge spirit",srcImg:"forge_spirit",src:"extraSkills"},{name:"cold snap",srcImg:"cold_snap",src:"extraSkills"},{name:"emp",srcImg:"emp",src:"extraSkills"},{name:"ice wall",srcImg:"ice_wall",src:"extraSkills"},{name:"alacrity",srcImg:"alacrity",src:"extraSkills"}],[{name:"emp",srcImg:"emp",src:"extraSkills"},{name:"tornado",srcImg:"tornado",src:"extraSkills"},{name:"sun strike",srcImg:"sun_strike",src:"extraSkills"},{name:"chaos meteor",srcImg:"chaos_meteor",src:"extraSkills"},{name:"deafening blast",srcImg:"deafening_blast",src:"extraSkills"}]],$(function(){heroMng.create(),itemMng.create();var e={name:"none",skills:[{obj:{name:"none",fun:function(){}},key:"q"},{obj:{name:"none",fun:function(){}},key:"w"},{obj:{name:"none",fun:function(){}},key:"e"},{obj:{name:"none",fun:function(){}},key:"d"},{obj:{name:"none",fun:function(){}},key:"f"},{obj:{name:"none",fun:function(){}},key:"r"}],extraSkills:[]};React.renderComponent(BaseTemplate({data:e}),document.getElementById("main"))});