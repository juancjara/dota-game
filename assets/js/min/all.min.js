...
var SkillSlot=React.createClass({displayName:"SkillSlot",render:function(){var e="same-line skill "+this.props.item.obj.srcImg;return React.DOM.li({className:e,key:this.props.key},React.DOM.div({className:"key-bind"},this.props.item.key))}}),SkillList=React.createClass({displayName:"SkillList",getInitialState:function(){return dispatcher.subscribe("changeSkill",this.changeSkill),dispatcher.subscribe("clearSkill",this.clearLastSkill),dispatcher.subscribe("getLastSkill",this.getLastSkill),dispatcher.subscribe("useExtraSkill",this.useExtraSkill),{skills:this.props.list,lastSkill:""}},clearLastSkill:function(){this.setState({lastSkill:""})},createFun:function(e){return function(t){e.fun(t)}},useExtraSkill:function(e){this.state.skills[e].obj.fun()},clearSkill:function(){var e=this.state.skills;e[3].obj=new Skill({key:"d"})},getLastSkill:function(){return this.state.lastSkill},changeSkill:function(e){{var t=this.props.extraSkills,s=this.state.skills;s[4].obj.fun,s[3].obj.fun}s[4].obj=s[3].obj,s[3].obj=t[e],this.setState({skills:s,lastSkill:t[e].name})},render:function(){return React.DOM.div({className:"hero-skill-slots"},React.DOM.ul({className:"clear-list"},this.state.skills.map(function(e,t){return SkillSlot({key:t,item:e})},this)))}}),ItemSlot=React.createClass({displayName:"ItemSlot",render:function(){var e="item same-line "+this.props.slot.item.srcImg;return React.DOM.li({className:e,key:this.props.key},React.DOM.div({className:"key-bind"},this.props.slot.key))}}),ItemList=React.createClass({displayName:"ItemList",getInitialState:function(){return{itemsSlots:this.props.itemsSlots}},componentDidMount:function(){for(var e,t=(this.state.itemsSlots.launch,0);t<this.state.itemsSlots.slots.length;t++)e=this.state.itemsSlots.slots[t],dispatcher.subscribeKey(e.key,this.createLaunch(this.state.itemsSlots,t))},createLaunch:function(e,t){return function(){e.launch(t)}},render:function(){return React.DOM.div({className:"hero-item-slots same-line vert-bot"},React.DOM.ul({className:"clear-list"},this.state.itemsSlots.slots.map(function(e,t){return ItemSlot({key:t,slot:e})},this)))}}),InvokerStatus=React.createClass({displayName:"InvokerStatus",getInitialState:function(){return dispatcher.subscribe("addInvokerState",this.addState),dispatcher.subscribe("clearInvokerState",this.clear),dispatcher.subscribe("isSameInvokerState",this.isSameState),{status:[{},{},{}]}},clear:function(){this.setState({status:[{},{},{}]})},addState:function(e){for(var t=this.state.status,s=0;s<t.length-1;s++)t[s]=t[s+1];t[2]=e,this.setState({status:t})},isSameState:function(e){var t=[e.charAt(0),e.charAt(1),e.charAt(2)];t.sort();for(var s=[],a=0;a<this.state.status.length;a++)s[a]=this.state.status[a].key;var l=s.slice(0);l.sort();for(var a=0;a<l.length;a++)if(l[a]!=t[a])return!1;return!0},render:function(){return React.DOM.ul({className:"clear-list"},this.state.status.map(function(e,t){var s="zoom-status same-line "+e.srcImg;return React.DOM.li({key:t,className:s}," ",e.key)},this))}}),HeroTemplate=React.createClass({displayName:"HeroTemplate",render:function(){var e="hero-img "+this.props.heroData.srcImg;return React.DOM.div({className:"hero-block same-line-top"},React.DOM.div({className:"hero-details same-line-top"},React.DOM.div({className:"hero-name"},this.props.heroData.name),React.DOM.div({className:e})),React.DOM.div({className:"same-line vert-bot"},InvokerStatus(null),SkillList({list:this.props.heroData.skills,extraSkills:this.props.heroData.extraSkills})))}}),ChallengeStep=React.createClass({displayName:"ChallengeStep",render:function(){var e="";this.props.item.done||(e=" no-used");var t="same-line zoom-challenge "+this.props.item.srcImg+e;return React.DOM.li({className:t,key:this.props.key})}}),StepToChooseFrom=React.createClass({displayName:"StepToChooseFrom",render:function(){var e="same-line zoom-challenge "+this.props.item.srcImg;return React.DOM.li({className:e,key:this.props.key,onClick:this.props.addStep.bind(null,this.props.item)})}}),SelectChallenge=React.createClass({displayName:"SelectChallenge",getInitialState:function(){return{steps:[],listChallenge:listChallenge}},addStep:function(e){var t=this.state.steps;t.push(e),this.setState({steps:t})},selectListChallenge:function(e){for(var t,s,a=this.state.listChallenge[e],l=[],i="",n=0;n<a.length;n++)if(i=a[n].name,"skills"==a[n].src){t=this.props.heroSelected.skills;for(var c=0;c<t.length;c++)if(i==t[c].obj.name){l.push(t[c].obj);break}}else if("extraSkills"==a[n].src){t=this.props.heroSelected.extraSkills;for(var c=0;c<t.length;c++)if(i==t[c].name){l.push(t[c]);break}}else if("items"==a[n].src){s=this.props.itemsSelected.slots;for(var c=0;c<s.length;c++)if(i==s[c].item.name){l.push(s[c].item);break}}this.setState({steps:l})},setChallenge:function(){dispatcher.execute("setChallenge",this.state.steps)},clearChallenge:function(){this.setState({steps:[]})},render:function(){var e,t,s=[],a=[],l=[],i="clear-list ";e=this.props.heroSelected.skills;for(var n=0;n<e.length;n++)e[n].obj.canBeChallenge&&s.push(e[n].obj);e=this.props.heroSelected.extraSkills;for(var n=0;n<e.length;n++)e[n].canBeChallenge&&a.push(e[n]);for(var t=this.props.itemsSelected.slots,n=0;n<t.length;n++)t[n].item.name.length&&l.push(t[n].item);return this.state.steps.length&&(i+="hide"),React.DOM.div({className:"select-challenge same-line-top"},React.DOM.h2(null," 1) Create you challenge"),React.DOM.button({onClick:this.setChallenge},"Set challenge"),React.DOM.button({onClick:this.clearChallenge},"Clear"),React.DOM.div({className:"preview-challenge"},React.DOM.h4(null,"Preview challenge"),React.DOM.ul({className:i},React.DOM.li({className:"same-line zoom-challenge no-item-challenge"}),React.DOM.li({className:"same-line zoom-challenge no-item-challenge"}),React.DOM.li({className:"same-line zoom-challenge no-item-challenge"}),React.DOM.li({className:"same-line zoom-challenge no-item-challenge"}),React.DOM.li({className:"same-line zoom-challenge no-item-challenge"})),React.DOM.ul({className:"clear-list"},this.state.steps.map(function(e,t){var s="same-line zoom-challenge "+e.srcImg;return React.DOM.li({className:s,key:t})},this))),React.DOM.label(null,"Custom skills to add to challenge"),React.DOM.ul({className:"custom-step clear-list"},s.map(function(e,t){return StepToChooseFrom({key:t,item:e,addStep:this.addStep})},this),a.map(function(e,t){return StepToChooseFrom({key:t,item:e,addStep:this.addStep})},this),l.map(function(e,t){return StepToChooseFrom({key:t,item:e,addStep:this.addStep})},this)),React.DOM.div(null,React.DOM.label(null,"Challenge list"),React.DOM.ul({className:"challenge-list"},this.state.listChallenge.map(function(e,t){return React.DOM.li({onClick:this.selectListChallenge.bind(null,t)},e.map(function(e,t){var s="same-line zoom-challenge "+e.srcImg;return React.DOM.span({className:s,key:t})},this))},this))))}}),ChallengeTemplate=React.createClass({displayName:"ChallengeTemplate",getInitialState:function(){dispatcher.subscribe("useSkill",this.action),dispatcher.subscribe("setChallenge",this.setChallenge);var e=new Challenge;return e.set([]),{challenge:e,message:"Choose challenge",startButton:"Start",countDown:null,urlChallenge:"<- Challenge your friend",wasChallenge:!1,friendData:{msg:"",time:""}}},componentDidMount:function(){var e=$("#challenge").text()||"";e.length&&API.consume("getChallenge",{id:e},this.searchChallenge)},searchChallenge:function(e,t){if(e)return void console.log(e);if("OK"!=t.msg)return void console.log(t.msg);var s=t.data,a=s.list,l=this.state.friendData;l.time=s.time,this.setState({friendData:l}),this.setChallenge(a,!0)},setChallenge:function(e,t){t=t||!1,this.stop(),this.setState({challenge:this.state.challenge.set(e),startButton:"Start",wasChallenge:t})},action:function(e){this.setState({challenge:this.state.challenge.step(e)}),this.state.challenge.active||dispatcher.offEvents()},generateUrl:function(){var e={};e.time=this.state.challenge.challengeLog.time,e.list=this.state.challenge.wishSteps,API.consume("createChallenge",{data:e},this.setUrlChallenge)},setMessage:function(e){this.setState({message:e})},clearChallenge:function(){dispatcher.execute("clearInvokerState"),dispatcher.unsubscribe("clickTarget")},startChallenge:function(){this.clearChallenge(),dispatcher.onEvents(),this.setState({challenge:this.state.challenge.start(),message:"",startButton:"Restart"})},onStart:function(){dispatcher.execute("clearHero");var e=this.state.countDown,t=this,s=function(){var e=new CountDown({onFinish:t.startChallenge,time:3,showOnSeconds:t.setMessage});e.start(),t.setState({countDown:e})};e?e.stop(s):s()},start:function(){var e=this.state.challenge;e.wishSteps.length?(this.setState({message:"Game starts in ..."}),this.stop(),setTimeout(this.onStart,500)):this.setState({message:"Choose challenge"})},stop:function(){this.clearChallenge(),dispatcher.offEvents();var e=this.state.challenge.stop();this.setState({challenge:e})},setUrlChallenge:function(e,t){if(e)return void console.log(e);if("OK"!=t.msg)return void console.log(t.msg);console.log(t);var s=window.location.host+"/"+t.url;this.setState({urlChallenge:s})},clickTarget:function(){dispatcher.execute("clickTarget")},render:function(){var e=this.state.challenge.isOver?"":"hide",t="message-block ";0==this.state.message.length&&(t=" hide");var s=this.state.wasChallenge?"":"hide";return React.DOM.div({className:"challenge-block"},React.DOM.h2(null," 2) Start your challenge  "),React.DOM.button({onClick:this.start},this.state.startButton),React.DOM.ul({className:"clear-list"},this.state.challenge.wishSteps.map(function(e,t){return ChallengeStep({key:t,item:e})},this)),React.DOM.div({className:e},React.DOM.div(null,"Tiempo ",this.state.challenge.challengeLog.time," segundos"),React.DOM.div({className:s},"Your friend finished this",React.DOM.span({className:"cross-out"}," stupid "),"challenge in ",this.state.friendData.time," seconds"),React.DOM.button({onClick:this.generateUrl},"Generate Url"),React.DOM.span(null,React.DOM.b(null," ",this.state.urlChallenge)),SummaryView({summary:this.state.challenge.challengeLog})),React.DOM.div({className:"field"},React.DOM.div({className:"message-block"},React.DOM.div({className:"message"},this.state.message)),React.DOM.div({className:"target",onClick:this.clickTarget})))}});SummaryView=React.createClass({displayName:"SummaryView",format3Decimals:function(e){return e/1e3},render:function(){var e=this,t=this.props.summary.listSkills.map(function(t){var s="same-line zoom-challenge "+t.srcImg,a=e.format3Decimals(t.castTime),l=e.format3Decimals(t.hitTime),i=e.format3Decimals(t.duration),n="fa fa-"+(t.status?"check":"close");return React.DOM.tr(null,React.DOM.td(null,React.DOM.div({className:s})),React.DOM.td(null,a),React.DOM.td(null,l),React.DOM.td(null,i),React.DOM.td(null,React.DOM.i({className:n})))});return React.DOM.div({className:"summary"},React.DOM.h3(null,"Summary"),React.DOM.table({className:"summary-table"},React.DOM.thead(null,React.DOM.tr(null,React.DOM.th(null,"Action"),React.DOM.th(null,"cast time"),React.DOM.th(null,"hit time"),React.DOM.th(null,"duration time"),React.DOM.th(null,"status"))),React.DOM.tbody(null,t)))}});var BaseTemplate=React.createClass({displayName:"BaseTemplate",getInitialState:function(){return dispatcher.subscribe("clearHero",this.clearHero),{data:this.props.data,itemsSlots:new ItemsSlots}},componentDidMount:function(){var e;e=heroMng.heros.invoker,this.updateHero(e)},createFun:function(e){return function(t){e.fun(t)}},updateHero:function(e){var t,s,a,l;l=this.state.data,t=e.skills;for(var i=0;i<t.length;i++)s=t[i],l.skills[i].obj=s,a=s.key,dispatcher.subscribeKey(a,this.createFun(s));l.name=e.name,l.srcImg=e.srcImg,l.extraSkills=e.extraSkills;this.setState({data:l})},clearHero:function(){if("invoker"==this.state.data.name){dispatcher.execute("clearSkill"),dispatcher.subscribeKey("d",function(){dispatcher.execute("useExtraSkill",3)}),dispatcher.subscribeKey("f",function(){dispatcher.execute("useExtraSkill",4)});var e=this.state.data;e.skills[3].obj=new Skill({key:"d",customFun:function(){}}),e.skills[4].obj=new Skill({key:"f",customFun:function(){}}),this.setState({data:e})}},render:function(){return React.DOM.div({main:!0},React.DOM.h1({className:"game-title"},"DOTA PRACTICE"),SelectChallenge({heroSelected:this.state.data,itemsSelected:this.state.itemsSlots}),React.DOM.div({className:"main-block same-line"},ChallengeTemplate({updateHero:this.updateHero,heroSelected:this.state.data,itemsSelected:this.state.itemsSlots}),React.DOM.div({className:"hero-data"},HeroTemplate({heroData:this.state.data}),ItemList({itemsSlots:this.state.itemsSlots})),React.DOM.div({className:"topics"},"Some skills require a click on an enemy(red circle) to be use.")))}});
