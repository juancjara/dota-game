...
var dispatcher=function(){var n=!1,e={},o={};return window.onkeydown=function(o){if(n){var i=o.keyCode?o.keyCode:o.which,u=KeyCode[i];u in e&&e[u]()}},{onEvents:function(){n=!0},offEvents:function(){n=!1},subscribeKey:function(n,o){e[n]=o},unsubscribeKey:function(n){e[n]=function(){}},unsubscribe:function(n){delete o[n]},subscribe:function(n,e){o[n]=e},execute:function(n,e){return n in o?o[n](e):void 0},show:function(){for(var n in e)console.log(n,e[n])}}}();
...
var Tab,TabsManager;Tab=function(t){t=t||{},this.name=t.name||"",this.text=t.text||"",this.target=t.target||"",this.active=!1,this.queueFun={},this.acceptKey=!1},Tab.prototype.switchStatus=function(t){return this.acceptKey=t,this},Tab.prototype.register=function(t,e){return this.queueFun[t]=e,this},Tab.prototype.unregister=function(t){return t in this.queueFun&&delete this.queueFun[t],this},Tab.prototype.emmit=function(t){var e,a;if(acceptKey){if(1===this.queueFun.length){e={};for(a in this.queueFun)e=this.queueFun[a];e(t)}else this.queueFun[t]();return this}},TabsManager=function(t){this.tabs=t,this.activeTab=-1},TabsManager.prototype.findByName=function(t){var e;for(e=0;e<this.tabs.length&&this.tabs[e]!==t;);return e},TabsManager.prototype.changeTab=function(t){return console.log(t,"index"),this.activeTab=t,this},TabsManager.prototype.registerEvent=function(t,e,a){var i;return i=this.findByName(t),0>i?this:(this.tabs[i].register(e,a),this)},TabsManager.prototype.emit=function(){return this},TabsManager.prototype.switchStatus=function(t,e){var a;return a=this.findByName(t),0>a?this:(this.tabs[a].switchStatus(e),this)},"undefined"!=typeof exports&&(exports.TabsManager=TabsManager,exports.Tab=Tab);
