...
var dispatcher=function(){var n=!1,e={},o={};return window.onkeydown=function(n){var e=n.keyCode?n.keyCode:n.which,o=KeyCode[e];console.log(o,"key"),dispatcher.execute("emit",o)},{onEvents:function(){n=!0},offEvents:function(){n=!1},subscribeKey:function(n,o){e[n]=o},unsubscribeKey:function(n){e[n]=function(){}},unsubscribe:function(n){delete o[n]},subscribe:function(n,e){o[n]=e},execute:function(n,e){return n in o?o[n](e):void 0},show:function(){for(var n in e)console.log(n,e[n])}}}();
