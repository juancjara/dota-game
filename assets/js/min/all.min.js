...
var Tab,TabsManager;Tab=function(t){t=t||{},this.name=t.name||"",this.text=t.text||"",this.target=t.target||"",this.active=!1,this.queueFun={},this.acceptKey=!1},Tab.prototype.switchStatus=function(t){return this.acceptKey=t,this},Tab.prototype.register=function(t,e){return this.queueFun[t]=e,this},Tab.prototype.unregister=function(t){return t in this.queueFun&&delete this.queueFun[t],this},Tab.prototype.emit=function(t){var e,i;if(this.acceptKey){if(1===this.queueFun.length){e={};for(i in this.queueFun)e=this.queueFun[i];e(t)}else this.queueFun[t]();return this}},TabsManager=function(t){this.tabs=t,this.activeTab=-1},TabsManager.prototype.findByName=function(t){var e;for(e=0;e<this.tabs.length&&this.tabs[e].name!==t;)e++;return e},TabsManager.prototype.changeTab=function(t){return this.activeTab=t,this},TabsManager.prototype.registerEvent=function(t,e,i){var a;return a=this.findByName(t),0>a?this:(this.tabs[a].register(e,i),this)},TabsManager.prototype.emit=function(t){return t?(this.tabs[this.activeTab].emit(t),this):this},TabsManager.prototype.switchStatus=function(t,e){var i;return i=this.findByName(t),0>i?this:(this.tabs[i].switchStatus(e),this)},"undefined"!=typeof exports&&(exports.TabsManager=TabsManager,exports.Tab=Tab);
